...
apm install file-icons            # Just helpful :)
apm install minimap               # Just helpful :)
apm install python-autopep8       # Automatically adjusts your code to PEP8 when saving. (Check in settings first)
